...
def get_density_score(kk,cc,mm,yy,field_density):
    ...
    S_Dc_c = score_two(weight, kk, 0.9, 0.85, 0.02, 0.015)
    S_Dm_m = score_two(weight, cc, 0.9, 0.85, 0.02, 0.015)
    S_Dy_y = score_two(weight, mm, 0.9, 0.8, 0.02, 0.015)
    S_Dk_k = score_two(weight, yy, 1.1, 1.0, 0.03, 0.02)
